...
const Navbar = () => {
  ...
  return (
    <div className={`sticky dark:bg-slate-900 dark:text-white top-0 z-50 ${
      sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-550 dark:text-white duration-300 transition-all ease-in-out" : ""
    }`}>
